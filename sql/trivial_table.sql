...
CREATE TABLE aime (id_user BIGINT AUTO_INCREMENT NOT NULL,
...
ALTER TABLE aime ADD CONSTRAINT FK_aime_id_langage FOREIGN KEY (id_langage) REFERENCES langage (id_langage);
